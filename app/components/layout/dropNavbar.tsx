...
const DropNavbar = (props: dropNavbarProps) => {
  return (
    <div
      className={`${props.className} absolute top-10 text-white bg-white/10 border border-white/30 -translate-x-1/2
      ...
      <div className="flex items-center">
        <div className="text-left min-w-[70x]">
          <p className="text-[18px]">
            {props.title}
            <span className="text-red-600">casino m8trix</span>{" "}
          </p>
        ...
        {props.button === "" ? (
          ...
          <button className="bg-red-600 text-[12px] w-[100px] h-[30px] px-2 ml-16">
            {props.button}
          </button>
        )}
      </div>
